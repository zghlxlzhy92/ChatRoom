...
public class Registry {
    ...
    public IUser register(IUser me) {
        try {
            IUser stub = (IUser)UnicastRemoteObject.exportObject(me, IUser.BOUND_PORT_CLIENT);
    ...
    public IChatServer register(IChatServer me) {
        try {
            IChatServer stub = (IChatServer) UnicastRemoteObject.exportObject(me, IChatServer.BOUND_PORT_CLIENT);
